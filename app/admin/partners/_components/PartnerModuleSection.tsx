...
const PartnerDirectory = dynamic(() => import("./PartnerDirectory"));
const PartnerApplicationList = dynamic(() => import("../applications/PartnerApplicationList"));
...
const PartnerServicesDashboard = dynamic(() => import("./PartnerServicesDashboard"), { loading: () => <p role="status" className="py-6 text-sm text-slate-400">Loading services…</p> });
...
export default function PartnerModuleSection({ section }: { section: PartnerModuleKey }) {
  ...
  const isServices = section === "overview" && activeView.key === "services";
  ...
  return <section aria-labelledby="partner-section-title" data-partner-module-panel className={isSummary || isPerformance || isRevenue || isServices ? "min-w-0" : "min-h-72 rounded-xl border border-sky-300/15 bg-[#0b1628] px-6 py-8 sm:min-h-80 sm:px-8"}>
    ...
    {section === "partners" ? <PartnerDirectory key={activeView.key} /> : section === "applications" ? <PartnerApplicationList /> : isSummary ? <div className="pt-6"><PartnerSummaryDashboard /></div> : isPerformance ? <div className="pt-6"><PartnerPerformanceDashboard /></div> : isRevenue ? <div className="pt-6"><PartnerRevenueDashboard /></div> : isServices ? <div className="pt-6"><PartnerServicesDashboard /></div> : <div className="py-8" aria-labelledby="partner-view-title" data-partner-view>
