...
export default function PartnerModuleSection({ section }: { section: PartnerModuleKey }) {
  ...
  return <section aria-labelledby="partner-section-title" data-partner-module-panel className={isSummary || isPerformance ? "min-w-0" : "min-h-72 rounded-xl border border-sky-300/15 bg-[#0b1628] px-6 py-8 sm:min-h-80 sm:px-8"}>
    ...
    {isSummary ? <div className="pt-6"><PartnerSummaryDashboard /></div> : isPerformance ? <div className="pt-6"><PartnerPerformanceDashboard /></div> : <div className="py-8" aria-labelledby="partner-view-title" data-partner-view>
