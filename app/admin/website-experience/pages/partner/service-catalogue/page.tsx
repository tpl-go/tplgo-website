  ...
  return (
    <AdminProtected requiredPermissions={["partner_service_catalogue.read"]}>
      <AdminShell title="Service Catalogue">
        ...
        <nav className="mb-4 flex flex-wrap items-center gap-2 rounded-2xl border border-sky-300/15 bg-[#0b1628]/95 p-4 text-xs font-black text-slate-400 shadow-lg shadow-black/20" aria-label="Website Experience breadcrumbs">
