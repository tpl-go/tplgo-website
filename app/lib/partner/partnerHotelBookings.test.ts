...
const booking={
 id:'11111111-1111-4111-8111-111111111111',operationId:'22222222-2222-4222-8222-222222222222',bookingRef:'TPL-QA-HOTEL-M3A-001',hotel:'TPL Synthetic Hotel — QA Only',service:'Hotel',room:'Synthetic Deluxe Room — QA Only',serviceScopeId:'33333333-3333-4333-8333-333333333333',supplyItemId:'44444444-4444-4444-8444-444444444444',stayStart:'2026-10-01',stayEnd:'2026-10-03',nights:2,roomCount:1,guestCount:{adults:2,children:0,total:2},guestDisplayName:'Synthetic Guest — QA Only',status:'CONFIRMED',allocationState:'ALLOCATED',paymentDisclosure:'TEST_NO_PAYMENT',version:1,sourceChannel:'TPL_STAGING_FIXTURE',syntheticFixture:true,acknowledgementKind:'ORIGINAL',lastClientSurface:'api',createdAt:'2026-09-24T00:00:00.000Z',updatedAt:'2026-09-24T00:00:00.000Z',allowedActions:[{code:'ACKNOWLEDGE',label:'Acknowledge booking'}],timeline:[],
} as const;
