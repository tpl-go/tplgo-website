...
export const packageDetail: PackageDetails = {
  id: "pkg-014",
  slug: "india-pilgrimage-spiritual-tour",

  title: "India Pilgrimage Spiritual Tour",
  tagline: "India Pilgrimage Spiritual Tour package",

  nights: 4,
  days: 5,

  route: ["Varanasi","Haridwar","Rishikesh"],
