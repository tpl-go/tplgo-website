...
export const packageDetail: PackageDetails = {
  id: "pkg-055",
  slug: "nepal-everest-adventure-tour",

  title: "Nepal Everest Adventure Expedition",
  tagline: "Nepal Everest Adventure Expedition package",

  nights: 4,
  days: 5,

  route: ["Kathmandu","Everest Region"],
