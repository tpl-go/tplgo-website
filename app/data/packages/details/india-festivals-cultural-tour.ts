...
export const packageDetail: PackageDetails = {
  id: "pkg-005",
  slug: "india-festivals-cultural-tour",

  title: "India Festivals & Cultural Traditions Tour",
  tagline: "India Festivals & Cultural Traditions Tour package",

  nights: 4,
  days: 5,

  route: ["Jaipur","Varanasi","Kolkata"],
