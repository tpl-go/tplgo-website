...
export const packageDetail: PackageDetails = {
  id: "pkg-003",
  slug: "unesco-world-heritage-india-tour",

  title: "India UNESCO World Heritage Sites Tour",
  tagline: "India UNESCO World Heritage Sites Tour package",

  nights: 4,
  days: 5,

  route: ["Agra","Khajuraho","Hampi"],
