...
export const packageDetail: PackageDetails = {
  id: "pkg-015",
  slug: "south-india-temple-circuit-tour",

  title: "South India Temple Circuit Tour",
  tagline: "South India Temple Circuit Tour package",

  nights: 4,
  days: 5,

  route: ["Madurai","Rameswaram","Tirupati"],
