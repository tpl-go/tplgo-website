...
export const packageDetail: PackageDetails = {
  id: "pkg-010",
  slug: "northeast-tribal-culture-tour",

  title: "North East Tribal Culture Experience Tour",
  tagline: "North East Tribal Culture Experience Tour package",

  nights: 4,
  days: 5,

  route: ["Shillong","Kohima","Itanagar"],
