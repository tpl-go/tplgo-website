...
export const packageDetail: PackageDetails = {
  id: "pkg-053",
  slug: "uttarakhand-trekking-adventure-tour",

  title: "Uttarakhand Trekking Adventure Tour",
  tagline: "Uttarakhand Trekking Adventure Tour package",

  nights: 4,
  days: 5,

  route: ["Rishikesh","Auli","Joshimath"],
