...
export default function HomestayConfirmationStayCard({
  ...
  return (
    <section
      className="homestay-confirmation-stay-card"
      style={{
    ...
    >
        ...
        >
          ...
          >
            <div style={{ minWidth: 0, flex: 1 }}>
              <div
                className="homestay-confirmation-stay-name"
                style={{
                  fontSize: "22px",
                  fontWeight: 900,
                  color: "#111827",
              ...
              <div
                className="homestay-confirmation-date-grid"
                style={{
                  marginTop: "6px",
                  fontSize: "14px",
                  color: "#2563eb",
          ...
          <div style={{ padding: "18px" }}>
            <div
              className="homestay-confirmation-info-grid"
              style={{
                border: "1px solid #e5e7eb",
                borderRadius: "18px",
                background:
            ...
            <div
              className="homestay-confirmation-chip-row"
              style={{
                marginTop: "14px",
                display: "flex",
                flexWrap: "wrap",
      ...
      <style jsx>{`
        @media (max-width: 767px) {
          .homestay-confirmation-stay-card {
          ...
          .homestay-confirmation-stay-name {
            font-size: 19px !important;
            line-height: 26px !important;
          }

          .homestay-confirmation-date-grid {
            grid-template-columns: 1fr !important;
            gap: 10px !important;
          }

          .homestay-confirmation-date-grid > div {
            min-width: 0 !important;
            width: 100% !important;
            text-align: left !important;
          }

          .homestay-confirmation-date-grid > div:first-child,
          .homestay-confirmation-date-grid > div:last-child {
          ...
          .homestay-confirmation-date-grid > div:first-child > div:nth-child(2),
          .homestay-confirmation-date-grid > div:last-child > div:nth-child(2) {
          ...
          .homestay-confirmation-date-grid > div:first-child > div,
          .homestay-confirmation-date-grid > div:last-child > div {
            max-width: 100% !important;
            white-space: normal !important;
          }

          .homestay-confirmation-date-grid > div:nth-child(2) {
            min-width: 0 !important;
            width: 100% !important;
          ...
          .homestay-confirmation-date-grid > div:nth-child(2) > div:first-child,
          .homestay-confirmation-date-grid > div:nth-child(2) > div:last-child {
            width: 100% !important;
          }

          .homestay-confirmation-info-grid {
            grid-template-columns: 1fr !important;
            gap: 10px !important;
          }

          .homestay-confirmation-chip-row {
            width: 100% !important;
            min-width: 0 !important;
            gap: 8px !important;
          }

          .homestay-confirmation-chip-row span {
            max-width: 100% !important;
            min-width: 0 !important;
            white-space: normal !important;
            overflow-wrap: anywhere !important;
