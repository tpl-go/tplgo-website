...
export default function BusConfirmationSuccessHeader({
  bookingId,
  ticketNumber,
  busName,
  operatorName,
      ...
      >
        ...
        >
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            >
              Your bus reservation has been successfully created. Keep your
            ...
            >
              {route ? <span style={neutralPillStyle}>{route}</span> : null}
              {travelDate ? (
                <span style={neutralPillStyle}>Journey: {travelDate}</span>
              ) : null}
              {boardingPoint ? (
                <span style={neutralPillStyle}>Boarding: {boardingPoint}</span>
              ) : null}
              {droppingPoint ? (
                <span style={neutralPillStyle}>Dropping: {droppingPoint}</span>
              ) : null}
            </div>
          </div>
