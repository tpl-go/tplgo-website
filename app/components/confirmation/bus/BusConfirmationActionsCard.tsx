...
export default function BusConfirmationActionsCard({
  bookingId,
  ticketNumber,
  email,
  mobile,
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ padding: "18px" }}>
            ...
            {ticketNumber ? (
              ...
              >
                <div style={miniLabelStyle}>Ticket Number</div>
                <div style={miniValueStyle}>{ticketNumber}</div>
              </div>
            ) : null}
        ...
        >
          ...
          >
            Keep your booking ID and ticket number ready while downloading
            ticket, printing bus confirmation, contacting support, or retrieving
            this bus booking later.
          </div>
        </div>
      </div>
    </aside>
