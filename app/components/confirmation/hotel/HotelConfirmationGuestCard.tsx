...
export default function HotelConfirmationGuestCard({
  travellers = [],
  contactDetails,
}: Props) {
  ...
  return (
    <section
      className="hotel-confirmation-guest-card"
      style={{
    ...
    >
      ...
      <div className="hotel-confirmation-card-body" style={{ padding: "22px" }}>
        ...
        <div
          className="hotel-confirmation-guest-grid"
          style={{
            display: "grid",
              ...
              {travellers.length > 0 ? (
                travellers.map((traveller, index) => (
                  <div
                    ...
                    className="hotel-confirmation-traveller-row"
                    style={{
                      border: "1px solid #e5e7eb",
                      borderRadius: "16px",
                      padding: "14px 16px",
      ...
      <style jsx>{`
        @media (max-width: 767px) {
          ...
          .hotel-confirmation-guest-grid {
            grid-template-columns: 1fr !important;
            gap: 14px !important;
          }

          .hotel-confirmation-traveller-row {
...
function InfoCard({
  ...
  return (
    <div
      className="hotel-confirmation-info-card"
      style={{
        border: "1px solid #e5e7eb",
        borderRadius: "18px",
        background: "#ffffff",
    ...
    >
      ...
      <div style={{ display: "grid", gap: "12px" }}>
        {rows.map((row, index) => (
          <div
            className="hotel-confirmation-info-row"
            key={`${row.label}-${index}`}
            style={{
              display: "flex",
              justifyContent: "space-between",
