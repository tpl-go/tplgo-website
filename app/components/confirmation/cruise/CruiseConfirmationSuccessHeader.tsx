...
export default function CruiseConfirmationSuccessHeader({
  bookingId,
  title,
      ...
      >
        ...
        >
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            >
              Your cruise reservation has been successfully created. Keep your
            ...
            >
              {cruiseLine ? (
                <span style={neutralPillStyle}>Cruise Line: {cruiseLine}</span>
              ) : null}

              <span style={neutralPillStyle}>
                Sailing Date: {formatDate(sailingDate)}
              </span>

              <span style={neutralPillStyle}>Status: Confirmed</span>
            </div>
          </div>
