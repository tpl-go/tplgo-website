...
export default function CabConfirmationActionsCard({
  bookingId,
  rideId,
  email,
  mobile,
    ...
    >
      ...
      >
        ...
        >
          ...
          <div style={{ padding: "18px" }}>
            ...
            {rideId ? (
              ...
              >
                <div style={miniLabelStyle}>Ride ID</div>
                <div style={miniValueStyle}>{rideId}</div>
              </div>
            ) : null}
        ...
        >
          ...
          >
            Keep your booking ID and ride ID ready while downloading voucher,
            printing cab confirmation, contacting support, or retrieving this
            ride later.
          </div>
        </div>
      </div>
