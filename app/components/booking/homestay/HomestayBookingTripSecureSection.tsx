...
export type HomestayTripSecurePayload = {
...
type Props = {
  isEnabled: boolean;
  onChange?: (payload: HomestayTripSecurePayload) => void;
};

const TRIP_SECURE_PRICE = 499;

export default function HomestayBookingTripSecureSection({
  isEnabled,
  onChange,
}: Props) {
          ...
          {!isEnabled ? (
            ...
            <div className="rounded-lg border border-[#d9e2ec] bg-[#f8fbff] p-5">
              ...
              <div className="mt-4 grid gap-3 md:grid-cols-[1fr_1fr_1fr_160px]">
                ...
                />
                <BenefitCard
                  title="Stay Protection"
                  subtitle="Extra reassurance for your homestay confirmation"
                />
