...
const ADDON_OPTIONS: AddonItem[] = [
  {
    ...
    subtitle: "Anniversary, birthday, honeymoon or cabin decor setup.",
    price: 1999,
  },
  {
    key: "dining",
    title: "Special Dining Upgrade",
    subtitle: "Upgrade your onboard dining experience with premium access.",
    price: 2499,
  },
  {
    key: "photo",
    title: "Photo Package",
    subtitle: "Capture your cruise moments with an onboard photo package.",
    price: 1499,
  },
  {
    key: "wifi",
    title: "Onboard Wi-Fi Pack",
    subtitle: "Stay connected during your sailing with internet access.",
    price: 999,
  },
];

export default function CruiseAddonsSection({
  isEnabled,
  onChange,
}: Props) {
  ...
  const addonsSummaryText =
    addonsStatus === "selected" && selectedAddonDetails.length > 0
      ...
      ? "Cruise add-ons skipped"
      : "No cruise add-on selected";
        ...
        >
          {!isEnabled ? (
            <div style={lockedBoxStyle}>
              ...
              >
                Please complete Cruise Protection first to continue with
                add-ons.
              </div>
            </div>
          ) : (
            <div style={cardStyle}>
              <div style={{ fontSize: "18px", fontWeight: 800, color: "#111827" }}>
                Add more comfort to your cruise
              </div>
