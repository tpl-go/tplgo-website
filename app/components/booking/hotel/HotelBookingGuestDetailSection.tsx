      ...
      >
        ...
        >
          ...
          <div className="flex shrink-0 items-center gap-2 md:gap-3">
            <span
              className={`max-w-[110px] text-right text-[10px] font-bold uppercase leading-4 md:max-w-none md:text-[13px] ${
        ...
        {isOpen && (
          <>
            <div className="flex flex-col items-start justify-between gap-3 border-b border-[#d9e2ec] bg-[#eef8ff] px-3 py-4 md:flex-row md:items-center md:gap-4 md:px-5">
              ...
              {!activeUser?.mobile ? (
                <button
                  ...
                  className="whitespace-nowrap rounded-full border border-[#bfdbfe] bg-white px-3 py-1.5 text-[13px] font-bold text-[#2a9fe8] md:border-0 md:bg-transparent md:px-0 md:py-0 md:text-[14px]"
                >
                  Login Now →
                </button>
              ) : null}
                      ...
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <button
                            ...
                            className="mt-1 border-0 bg-transparent p-0 text-left text-[15px] font-bold leading-snug text-[#55b2ea] md:text-[16px]"
                          >
                            {completed
