...
type Props = {
  isEnabled: boolean;
  onChange?: (payload: HotelCabPayload) => void;
};
...
export default function HotelBookingCabSection({
  isEnabled,
  onChange,
}: Props) {
    ...
    <>
            ...
            {!isEnabled ? (
              ...
              <div className="rounded-lg border border-[#d9e2ec] bg-[#f8fbff] p-4 md:p-5">
                ...
                <div className="mt-4 grid gap-4 md:grid-cols-3">
                  ...
                  <CabCard
                    title="No Cab Needed"
                    subtitle="Skip cab booking for this stay."
                    price={0}
      ...
      {showCabModal && (
        <ModalOverlay onClose={() => setShowCabModal(false)}>
          <div className="max-h-[88vh] w-full overflow-hidden rounded-t-3xl bg-white shadow-[0_20px_60px_rgba(0,0,0,0.28)] md:max-w-[860px] md:rounded-xl">
            ...
            <div className="max-h-[calc(88vh-76px)] overflow-y-auto p-4 md:max-h-none md:p-5">
                ...
                {CAB_OPTIONS.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`rounded-lg p-4 text-left transition md:p-5 ${
                        active
                    ...
                    >
                      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                        ...
                        <div className="whitespace-nowrap text-[18px] font-extrabold text-[#111827] md:text-[20px]">
...
function CabCard({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`min-h-[128px] rounded-lg p-4 text-left transition md:min-h-[150px] ${
        active
          ? "border-2 border-[#38bdf8] bg-[#eef8ff]"
          : "border border-[#d9e2ec] bg-white"
      }`}
  ...
  return (
    ...
    >
      <div
        ...
        className="max-h-[100vh] w-full overflow-y-auto md:max-h-[90vh]"
      >
        {children}
      </div>
    </div>
