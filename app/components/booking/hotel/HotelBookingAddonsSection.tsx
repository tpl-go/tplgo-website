...
export type HotelAddonsPayload = {
...
type Props = {
  isEnabled: boolean;
  onChange?: (payload: HotelAddonsPayload) => void;
};
...
const ADDON_OPTIONS: AddonItem[] = [
  {
    key: "meal",
    title: "Meal Upgrade",
    subtitle: "Pre-book meals for added convenience.",
    price: 1200,
  },
  {
    key: "decor",
    title: "Room Decoration",
    subtitle: "Special setup for anniversary or celebration.",
    price: 699,
  },
  {
    key: "assistance",
    title: "Priority Assistance",
    subtitle: "Extra support for check-in and stay handling.",
    price: 499,
  },
  {
    key: "flexi",
    title: "Flexi Stay Protection",
    subtitle: "Extra flexibility with support benefits.",
    price: 999,
  },
];

export default function HotelBookingAddonsSection({
  isEnabled,
  onChange,
}: Props) {
            ...
            <div className="rounded-lg border border-[#d9e2ec] bg-[#f8fbff] p-5">
              ...
              <div className="mt-5 flex flex-wrap items-center justify-between gap-3">
                ...
                <button
                  type="button"
                  onClick={handleSkip}
                  className={`h-[42px] rounded-lg px-4 font-bold transition ${
                    addonsStatus === "skipped"
