        ...
        {bookings.length === 0 ? (
          ...
          bookings.map((booking) => {
            ...
            return (
              <div
                key={booking.id}
                className="overflow-hidden rounded-[24px] border border-gray-200 bg-white shadow-[0_10px_30px_rgba(15,23,42,0.05)]"
              >
                <div className="border-b border-gray-200 bg-[linear-gradient(180deg,#f8fbff_0%,#ffffff_100%)] px-5 py-4">
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="rounded-full bg-blue-50 px-3 py-1 text-[11px] font-semibold uppercase text-blue-700">
                          {booking.type}
                        </span>
                      ...
                      <div className="mt-3 grid grid-cols-1 gap-2 text-[13px] text-slate-600 sm:grid-cols-2 xl:grid-cols-4">
                        <p>
                    ...
                    <div className="min-w-[220px] shrink-0 rounded-2xl border border-slate-200 bg-white px-4 py-4 shadow-sm">
...
function ActionButton({
  ...
  const className =
    variant === "primary"
      ? "rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-[12px] font-semibold text-orange-700 transition hover:bg-orange-100 whitespace-nowrap shrink-0"
      : variant === "danger"
      ? "rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-[12px] font-semibold text-orange-700 transition hover:bg-orange-100 whitespace-nowrap shrink-0"
      : variant === "success"
      ? "rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-[12px] font-semibold text-orange-700 transition hover:bg-orange-100 whitespace-nowrap shrink-0"
