      ...
      <fieldset disabled={saving} className="min-w-0 space-y-8 px-6 py-6">
        ...
        <section>
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <ProfileLocationFields country={formData.country} region={formData.state} city={formData.city} disabled={saving} onCountry={value=>setFormData(prev=>({...prev,country:value,state:"",city:""}))} onRegion={value=>setFormData(prev=>({...prev,state:value}))} onCity={value=>updateField("city",value)} />
          </div>
        </section>
