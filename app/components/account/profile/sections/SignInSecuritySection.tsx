...
export default function SignInSecuritySection() {
  return <div className="bg-white">
    ...
    <div className="space-y-5 px-6 py-6"><UserSignInDetails /><p className="text-sm leading-6 text-slate-600">There is no TPL password to reset here. Manage your Google password through your Google account. Never share a sign-in code.</p><p className="text-sm leading-6 text-slate-600">Use Log out in the account menu to leave this account. Device information is available separately; signing out other devices is not available here.</p></div>
  </div>;
}
