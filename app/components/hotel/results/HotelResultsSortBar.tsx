...
const SORT_OPTIONS: { key: HotelSortOption; label: string }[] = [
...
export default function HotelResultsSortBar({
  activeSort,
  onChange,
}: Props) {
  ...
  const handleScroll = (direction: "left" | "right") => {
    ...
    const firstButton = scrollRef.current.querySelector(
      '[data-sort-item="true"]'
    ) as HTMLButtonElement | null;

    const step = firstButton ? firstButton.offsetWidth : 180;
