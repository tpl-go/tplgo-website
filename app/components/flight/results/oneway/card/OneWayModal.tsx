...
export default function OneWayModal({
  ...
  return (
    ...
    >
      <div
        ref={panelRef}
        className={`relative max-h-[92vh] w-full overflow-hidden rounded-t-[28px] border border-white/70 bg-white shadow-[0_-18px_60px_rgba(15,23,42,0.28)] sm:max-h-[90vh] sm:rounded-3xl sm:shadow-[0_24px_80px_rgba(15,23,42,0.24)] ${maxWidthClass}`}
