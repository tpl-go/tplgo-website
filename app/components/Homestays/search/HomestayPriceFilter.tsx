...
export default function HomestayPriceFilter({ dispatch }: any) {
  ...
  return (
    <div ref={dropdownRef} className="relative w-full shrink-0 md:w-auto">
      <div
      ...
      >
        ...
        <div className="flex w-full items-center justify-between">
          <span className="truncate text-base md:text-lg font-extrabold text-slate-950">
            {selected}
          </span>
      ...
      {open && (
        <div className="absolute left-0 top-[82px] md:top-[90px] z-[9999] w-full overflow-hidden rounded-2xl border border-slate-700 bg-white text-black shadow-2xl">
          {["₹0–₹1500", "₹1500–₹2500", "₹2500–₹5000", "₹5000+"].map(
            (range) => (
              <div
                key={range}
