...
export default function HomestayCitySelector({
  dispatch,
  value = "",
          ...
          {filtered.length > 0 ? (
            filtered.map((city, i) => (
              <div
                ...
                className="flex cursor-pointer items-center gap-2 px-4 py-3 text-sm font-semibold hover:bg-orange-50"
              >
                <MapPin size={16} />
                {city}
              </div>
