...
export default function InsurancePlanDetailsModal({
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-black/45 px-3 py-4 backdrop-blur-sm md:px-4 md:py-6">
      <div className="mx-auto flex max-h-[92vh] max-w-5xl flex-col overflow-hidden rounded-[24px] bg-white shadow-2xl md:rounded-3xl">
        ...
        <div className="grid gap-5 p-4 md:p-5 lg:grid-cols-[1fr_280px]">
            ...
            <section className="rounded-2xl border border-gray-100 bg-gray-50 p-4">
              ...
              <div className="mt-3 grid gap-3 md:grid-cols-2">
                {plan.features.map((feature) => (
                  <div
                    key={feature}
                    className="break-words rounded-xl border border-green-100 bg-white p-3 text-sm font-bold leading-5 text-gray-800"
                  >
                    ✅ {feature}
                  </div>
                ))}
            ...
            <section className="rounded-2xl border border-gray-100 bg-white p-4">
              ...
              <div className="mt-3 space-y-2">
                {plan.exclusions.map((item) => (
                  <p
                    key={item}
                    className="break-words rounded-xl border border-red-100 bg-red-50 p-3 text-sm font-semibold leading-5 text-red-700"
                  >
                    ⚠ {item}
                  </p>
                ))}
