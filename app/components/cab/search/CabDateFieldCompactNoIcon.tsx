...
export default function CabDateFieldCompactNoIcon({
  label,
  value,
  onChange,
}: Props) {
    ...
    <>
      ...
      >
        <div className="min-w-0">
          <p className="mb-1 truncate text-[10px] font-bold uppercase tracking-wide text-slate-600">
            {label}
          </p>
      ...
      {mounted &&
        ...
        createPortal(
          <div
            ref={popupRef}
            className="absolute z-[9999] rounded-2xl border border-black bg-white p-5 shadow-2xl"
            style={{
              top: popupStyle.top,
