...
export default function HotelPaymentOptionSection({
  ...
  return (
    <section className="overflow-hidden rounded-2xl border border-[#d9e2ec] bg-white shadow-[0_2px_8px_rgba(15,23,42,0.04)]">
      ...
      <PaymentRow
        testId="hotel-payment-method-upi"
        icon="🇮🇳"
        title="UPI Options"
      ...
      <PaymentRow
        testId="hotel-payment-method-qr"
        icon="▦"
        title="QR Payment"
      ...
      <PaymentRow
        testId="hotel-payment-method-cards"
        icon="💳"
      ...
      <PaymentRow
        testId="hotel-payment-method-emi"
        icon="🧾"
        title="EMI"
      ...
      <PaymentRow
        testId="hotel-payment-method-netbanking"
        icon="🏦"
        title="Net Banking"
  ...
  return (
    ...
    >
      ...
      <div className="flex shrink-0 items-center gap-3">
        ...
        <span className={`text-[18px] font-extrabold ${disabled ? "text-[#94a3b8]" : isActive ? "text-[#0ea5e9]" : "text-[#60a5fa]"}`}>
          {disabled ? "×" : "›"}
        </span>
      </div>
    </div>
