...
type Props = {
  guests: HotelManageGuest[];
  onChange: (guests: HotelManageGuest[]) => void;
  onSave: () => void;
};

export default function HotelManageGuestDetails({
  guests,
  onChange,
  onSave,
}: Props) {
  return (
    <div className="space-y-5">
      ...
      {guests.map((guest, index) => (
        ...
        >
          <p className="text-sm font-bold text-[#111827]">Guest {index + 1}</p>
