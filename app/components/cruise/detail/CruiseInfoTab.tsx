  ...
  return (
    <div className="space-y-4 p-4">
      <div className="rounded-2xl border bg-white p-4">
        <div className="text-[16px] font-semibold text-slate-900">Overview</div>
        <div className="mt-2 text-sm leading-6 text-slate-600">{overview}</div>
      </div>

      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <div className="rounded-2xl border bg-white p-4">
          <div className="text-[16px] font-semibold text-slate-900">Cruise Details</div>
        ...
        <div className="rounded-2xl border bg-white p-4">
          <div className="text-[16px] font-semibold text-slate-900">Cabin Pricing</div>
          <div className="mt-3 space-y-2 text-sm text-slate-600">
